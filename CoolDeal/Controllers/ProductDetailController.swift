...
//        scrollView.isHidden = true
    ...
    let productDetailInfo = ProductDetailInfo(withTitle: "Product Detail", infoText: "detail1\ndetail2\ndetail3\ndetail4")
    ...
    let productSizeAndFitInfo = ProductSizeAndFitInfo(withTitle: "Size and Fit", infoText: "text 1\ntext2\ntext3\ntext4")
